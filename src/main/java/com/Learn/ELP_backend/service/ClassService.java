...
public interface ClassService {
    ...
    // Add, delete, update qustions inside existing quiz
    Question addQuestionToQuiz(String classId, String yearMonth, String quizId, Question question);

    Question updateQuestionInQuiz(String classId, String yearMonth, String quizId, String questionId,
            Question questionUpdate);

    void deleteQuestionFromQuiz(String classId, String yearMonth, String quizId, String questionId);
